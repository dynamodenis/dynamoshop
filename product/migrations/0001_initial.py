# Generated by Django 3.1.2 on 2020-10-16 07:16
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('appartment_address', models.CharField(blank=True, max_length=100)),
                ('country', django_countries.fields.CountryField(max_length=2)),
                ('zip', models.CharField(max_length=100)),
                ('address_type', models.CharField(choices=[('B', 'Billing'), ('S', 'Shipping')], max_length=2)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('S', 'Shirt'), ('SW', 'Sport Wear'), ('OW', 'Outwear'), ('E', 'Electronic')], max_length=2)),
